...
export default function Formulario() {
    ...
    const {setMsgAlert , setAnimaAlert} = hookContext()
    ...
    const handleWhatsAppClick = () => {
        ...
        if (!inputNome || !inputMail || !inputNum) {
            ...
            setMsgAlert('preencha os campos')
            setAnimaAlert(true)
